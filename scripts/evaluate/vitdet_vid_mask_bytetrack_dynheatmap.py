...
class SlidingWindowHeatmap:
    ...
    def __init__(self, image_shape, region_size, window_size):
    ...
    def update(self, boxes):
        region_map = self._boxes_to_grid(boxes) if boxes is not None else self._empty_map()
